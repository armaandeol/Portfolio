...
type BlogpostDocumentDataSlicesSlice = ImageBlockSlice | ContentIndexSlice | RichTextSlice;
...
type ProjectDocumentDataSlicesSlice = ContentIndexSlice | ImageBlockSlice | RichTextSlice;
...
interface SettingsDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	linkdin_link: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
...
export interface ExperienceSliceDefaultPrimaryItemItem {
	...
	/**
	 * Instituition field in *Experience → Default → Primary → Item*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
